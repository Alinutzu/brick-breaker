...
window.Levels = (function(){
  ...
  function compute(mode, level, wave){
    ...
    const offsetX = (800 - (BRICK_COLS * (BRICK_W + BRICK_GAP) - BRICK_GAP)) / 2; // assumes W=800
    ...
    for(let r=0;r<BRICK_ROWS;r++){
      for(let c=0;c<BRICK_COLS;c++){
        ...
        // second corridor only opens later; blueprint includes bricks initially
  ...
  function openSecondCorridor(state){
    // Removes bricks in barrier area at corridor2Col (1 column width) to open path
